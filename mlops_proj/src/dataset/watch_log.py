...
class watch_log_dataset:
    ...
    def _preprocessing(self): # convert "content_id" into integer form
        ...
        # Create "content_id" decoding map
...
def get_datasets(scaler=None, label_encoder=None):
    ...
    train_dataset = watch_log_dataset(train_df, scaler, label_encoder)
    val_dataset = watch_log_dataset(val_df, scaler=train_dataset.scaler, label_encoder=train_dataset.label_encoder)
    test_dataset = watch_log_dataset(test_df, scaler=train_dataset.scaler, label_encoder=train_dataset.label_encoder)
